...
const (
	...
	GreetService_BiDirectionGreet_FullMethodName  = "/greet.GreetService/BiDirectionGreet"
...
type GreetServiceClient interface {
	...
	BiDirectionGreet(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[GreetRequest, GreetResponse], error)
...
func (c *greetServiceClient) BiDirectionGreet(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[GreetRequest, GreetResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], GreetService_BiDirectionGreet_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GreetRequest, GreetResponse]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_BiDirectionGreetClient = grpc.BidiStreamingClient[GreetRequest, GreetResponse]
...
type GreetServiceServer interface {
	...
	BiDirectionGreet(grpc.BidiStreamingServer[GreetRequest, GreetResponse]) error
...
func (UnimplementedGreetServiceServer) BiDirectionGreet(grpc.BidiStreamingServer[GreetRequest, GreetResponse]) error {
	return status.Errorf(codes.Unimplemented, "method BiDirectionGreet not implemented")
}
...
func _GreetService_BiDirectionGreet_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).BiDirectionGreet(&grpc.GenericServerStream[GreetRequest, GreetResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_BiDirectionGreetServer = grpc.BidiStreamingServer[GreetRequest, GreetResponse]
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "BiDirectionGreet",
			Handler:       _GreetService_BiDirectionGreet_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
